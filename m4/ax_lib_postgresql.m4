...
# DESCRIPTION
#
#   This macro provides tests of availability of PostgreSQL of particular
#   version or newer.
#
...
#
#   yes - do check for PostgreSQL in standard locations (pg_config should
#   be in the PATH)
#
...
#   Copyright (c) 2017 Jakub Galgonek <jakub.galgonek@uochb.cas.cz>
#
...
[
    ...
    if test "$found_postgresql" = "no"; then
